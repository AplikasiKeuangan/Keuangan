        ...
        if ($request->ajax()) {
            ...
            return DataTables::of($siswa)
                ->addColumn('action', function($siswa){
                    return '<a href="./siswa/'.$siswa->nis.'/'.$siswa->nama_siswa.'/detail" class="btn btn-light"><i class="fa fa-pencil-square-o"></i> Detail</a> <a href="./siswa/'.$siswa->nis.'/'.$siswa->nama_siswa.'/edit" class="btn btn-primary"><i class="fa fa-pencil-square-o"></i> Edit</a> <a data-admin="admin/'.$siswa->nis.'/'.$siswa->nama_siswa.'/hapus" class="btn btn-danger admin-remove" href="#" onclick="adminDelete()"><i class="fa fa-trash"></i></a>';
                })
                ->make(true);
        }else{
            return abort(403);
