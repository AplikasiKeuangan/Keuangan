                              ...
                              <div class="card-body card-block">
                                 <form method="post" id="form1" class="form-horizontal" action="{{ route('admin-siswa-store') }}" >
                                    ...
                                    <div class="row form-group">
                                          ...
                                          <div class="col-12 col-md-9">
                                             <input type="text" id="hf-kewarganegaraan" name="kewarganegaraan" placeholder="Kewarganegaraan" required="" class="form-control">
                                          </div>
                                    </div>
                                    <div class="row form-group">
                                          <div class="col col-md-3">
                                    ...
                                    <div class="row form-group">
                                          ...
                                          <div class="col-12 col-md-9">
                                             <input type="gmail" id="hf-asal-sekolah" name="asal_sekolah" placeholder="Asal Sekolah" required="" class="form-control">
                                          </div>
                                    </div>
                                 </form>
                              </div>
