        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
               <li class="breadcrumb-item"><a href="{{route('admin-Data-tagihan-index1')}}">Tagihan Siswa</a></li>
              ...
              @foreach ($tagihan as $tagihan)
               ...
               @endphp
                <tr>
                    ...
                    <td align="center"><a href="/admin/Data/keuangan/{{$tagihan->id}}/edit" class="btn btn-primary"><i class="fa fa-edit"></i></a>
                         
                    <a href="/admin/Data/keuangan/{{$tagihan->id}}/hapus"class="button delete-confirm btn btn-danger"><i class="fa fa-eraser"></i></a></td>
